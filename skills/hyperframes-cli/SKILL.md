...
description: >
  HyperFrames CLI command reference (init / lint / preview / render / transcribe /
  tts / doctor / browser / info / upgrade / compositions / docs / benchmark). Used
  for scaffolding projects, validating compositions, studio preview, rendering video,
  audio transcription, TTS generation, and troubleshooting HyperFrames environment
  issues. This skill is reference-only and is not exposed as a slash command.
version: 1.0.0
---
...
`init` creates the correct file structure, copies media, transcribes audio with Whisper, and installs AI coding skills. Use it instead of creating files by hand.
