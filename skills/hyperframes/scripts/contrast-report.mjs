...
//
// NOTE — optional tool: this script is NOT part of the main pipeline and its
// dependencies (`sharp`, `@hyperframes/producer`) are intentionally NOT in
// package.json. Install them on demand before running:
//   npm i -g sharp @hyperframes/producer   (or: npm i sharp @hyperframes/producer)
